    ...
    return (
      <div className="min-h-screen bg-white max-w-md mx-auto flex flex-col font-sans text-gray-900 border-x italic font-black uppercase">
        ...
        <div className="p-6 space-y-12 overflow-y-auto">
          ...
          <section className="space-y-4"><h3 className="text-xl font-black text-blue-800 italic uppercase">1. DE BEDOELING</h3><p className="text-lg text-gray-600 font-bold italic normal-case">De KetoVoor app is uw persoonlijke assistent. De app rekent exact uit hoeveel u moet eten op basis van uw eigen gewicht en uw doelstelling.</p></section>
          <section className="space-y-4"><h3 className="text-xl font-black text-blue-800 italic uppercase">2. HET DAGMENU</h3><p className="text-lg text-gray-600 font-bold italic normal-case">Op het scherm "VANDAAG" ziet u de maaltijden. Klik op een gerecht voor de bereiding. Bevalt een voorstel u niet? Klik op "WISSEL".</p></section>
          <section className="space-y-4 bg-blue-50 p-6 rounded-3xl border-4 border-blue-100"><h3 className="text-xl font-black text-blue-700 leading-none italic uppercase underline decoration-blue-200">3. BELANGRIJK!</h3><p className="text-lg text-blue-900 font-black italic normal-case">Wanneer u bent afgevallen, klik in het scherm "BEHEER" op "PLAN HERBEREKENEN". De app past dan direct de porties aan.</p></section>
    ...
    return (
      <div className="min-h-screen bg-white max-w-md mx-auto flex flex-col font-sans text-gray-900 border-x">
        ...
        <div className="p-6 italic font-black">
          ...
          <div className="grid grid-cols-4 gap-2 mb-8 text-center bg-blue-50/30 p-3 rounded-2xl border border-blue-100 italic">
             <div><p className="text-[9px] opacity-40 uppercase italic">KCAL</p><p className="text-base text-orange-600">{r.macros.kcal}</p></div>
             <div><p className="text-[9px] opacity-40 uppercase italic">EIWIT</p><p className="text-base text-blue-700">{r.macros.eiwit}g</p></div>
             <div><p className="text-[9px] opacity-40 uppercase italic font-black italic">VET</p><p className="text-base text-yellow-600 font-black">{r.macros.vet}g</p></div>
          ...
          <div className="space-y-8 font-black italic font-black">
              ...
              <div className="space-y-1">{r.ingredienten.map((ing, i) => <div key={i} className="flex justify-between border-b border-gray-50 py-2 text-base font-bold text-gray-700 font-black italic"><span>{ing.item}</span><span className="text-blue-700 font-black italic">{ing.hoeveelheid} {ing.eenheid}</span></div>)}</div>
              ...
              {r.tips && r.tips.length > 0 && (<div className="bg-amber-50 border-2 border-amber-100 p-5 rounded-2xl mt-6 italic font-black font-black font-black font-black font-black font-black"><h4 className="flex items-center gap-2 text-amber-800 text-xs font-black uppercase mb-2 italic"><Star size={16} fill="#92400e"/> TIP VAN DE CHEF:</h4><p className="text-base text-amber-900 leading-tight italic italic">"{r.tips[0]}"</p></div>)}
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans flex justify-center text-gray-900 select-none uppercase italic font-black">
      <div className="w-full max-w-md bg-white min-h-screen shadow-2xl flex flex-col relative overflow-hidden">
        <div ref={scrollRef} key={pagina} className="flex-grow overflow-y-auto pb-40 px-4">
          ...
          {pagina === 'welkom' && (
            <div className="h-screen flex flex-col items-center justify-center text-center px-10">
              ...
              <h1 className="text-6xl font-black italic text-blue-600 mb-4 uppercase leading-none italic font-black">KETO<br/>VOOR</h1>
          ...
          {pagina === 'onboarding' && (
            <div className="pt-6 flex flex-col h-full italic">
              <h2 className="text-3xl uppercase border-b-4 border-blue-600 inline-block self-start mb-6 font-black italic">UW PROFIEL</h2>
              <div className="space-y-6">
                <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100 text-center italic font-black">
                  ...
                  <input type="text" inputMode="decimal" value={profiel.gewicht} placeholder="TYP UW GEWICHT" onChange={(e) => setProfiel({...profiel, gewicht: e.target.value})} className="w-full bg-white border-2 border-blue-100 p-3 rounded-xl text-center font-black text-5xl text-blue-600 outline-none placeholder:text-blue-100 placeholder:text-base italic" />
                </div>
            ...
            <div className="pt-6 italic font-black">
              <div className="flex flex-col gap-5 mb-10">
                <div className="flex justify-between items-center italic">
                   <div><p className="text-[10px] uppercase text-blue-700 font-black italic tracking-widest">VANDAAG</p><h2 className="text-5xl font-black uppercase italic tracking-tighter">MENU</h2></div>
                ...
                {weekPlan[vandaagNaam] && Object.entries(weekPlan[vandaagNaam]).map(([type, r]) => (
                  <div key={type} onClick={() => setGeselecteerdRecept(r)} className="bg-white border-2 border-gray-100 rounded-[2.5rem] p-4 flex items-center gap-4 shadow-sm active:scale-95 border-b-8">
                    ...
                    <div className="flex-grow">
                      ...
                      <h3 className="text-base leading-tight mb-1 text-gray-800 uppercase italic font-black">{r.titel}</h3>
                      <div className="flex gap-4 text-[10px] font-black uppercase italic italic font-black"><span className="text-orange-500 font-black">{r.macros.kcal} KCAL</span><span className="text-blue-600 font-black">{r.macros.eiwit}G EIWIT</span></div>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {pagina === 'logboek' && (
            <div className="pt-6 text-left italic font-black font-black">
              ...
              <div className="grid grid-cols-2 gap-3 mb-6 font-black font-black">
                 ...
                 <div className="bg-gray-50 p-5 rounded-2xl text-gray-700 text-center border-b-8 border-gray-200 shadow-inner italic font-black">
          ...
          {pagina === 'planner' && (
            <div className="pt-10 italic font-black font-black">
              ...
              <div className="space-y-4 font-black italic">
                {dagenLijst.map(dag => (
                  <div key={dag} className={`p-4 rounded-3xl border-b-8 ${dag === vandaagNaam ? 'bg-blue-50 border-blue-200 shadow-xl italic' : 'bg-white border-gray-50 opacity-50 shadow-inner'}`}>
                    <h3 className={`uppercase text-lg mb-6 font-black italic italic ${dag === vandaagNaam ? 'text-blue-700 underline decoration-blue-200 font-black' : 'text-gray-400 font-black font-black font-black italic'}`}>{dag}</h3>
            ...
            <div className="pt-6 italic font-black font-black">
              ...
              <div className="bg-blue-50 p-6 rounded-2xl mb-6 border border-blue-100 font-black italic">
                ...
                <div className="space-y-2 italic font-black">
                  <div className="flex justify-between items-center text-xl font-black italic font-black"><span>GEWICHT</span> <span className="text-blue-700">{profiel.gewicht} KG</span></div>
              ...
              <div className="space-y-4 font-black italic">
                  <button onClick={() => genereerPlan(profiel)} disabled={isUpdating} className={`w-full py-5 rounded-xl font-black uppercase text-lg shadow-lg active:scale-95 transition-all flex items-center justify-center gap-4 italic font-black ${isUpdating ? 'bg-orange-500 animate-pulse' : 'bg-blue-600 text-white font-black'}`}>
                    <RefreshCw size={36} className={isUpdating ? 'animate-spin text-white' : ''} />
                    {isUpdating ? 'SYNC...' : 'PLAN HERBEREKENEN'}
                  </button>
                  <p className="text-[10px] text-gray-400 uppercase text-center font-black italic">KLIK HIERBOVEN NA GEWICHTSVERLIES.</p>
              </div>
              <button onClick={() => setShowResetModal(true)} className="w-full py-4 text-red-600 font-black uppercase text-sm border-2 border-red-50 rounded-xl mt-12 hover:bg-red-50 italic">WISSEN & OPNIEUW BEGINNEN</button>
            </div>
          )}
        </div>
        ...
        {showResetModal && (<div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[9999] flex items-center justify-center p-8 uppercase italic font-black font-black"><div className="bg-white w-full rounded-[3.5rem] p-10 text-center shadow-2xl border-t-[15px] border-orange-500 font-black"><AlertTriangle size={100} className="text-orange-500 mx-auto mb-6 animate-pulse font-black" /><h3 className="text-3xl font-black mb-2 italic">ALLES WISSEN?</h3><p className="text-xl text-gray-600 mb-12 font-black italic uppercase italic">WEET U ZEKER DAT U ALLES WILT WISSEN EN OPNIEUW WILT BEGINNEN?</p><div className="flex flex-col gap-4 font-black italic"><button onClick={fullReset} className="w-full bg-red-600 text-white py-6 rounded-3xl font-black text-2xl uppercase">JA, WIS ALLES</button><button onClick={() => setShowResetModal(false)} className="w-full bg-gray-100 text-gray-600 py-4 rounded-3xl font-black text-lg uppercase italic font-black">NEE, STOP</button></div></div></div>)}
        {showSuccessSaved && (<div className="fixed inset-0 bg-black/80 backdrop-blur-md z-[9999] flex items-center justify-center p-8 uppercase italic font-black font-black"><div className="bg-white w-full rounded-[2.5rem] p-8 text-center shadow-2xl border-t-[10px] border-blue-600 font-black font-black"><CheckCircle size={100} className="text-blue-600 mx-auto mb-6 font-black" /><h3 className="text-3xl font-black mb-4 font-black italic uppercase">OPGESLAGEN!</h3><p className="text-lg text-gray-600 mb-10 font-black italic italic">UW NIEUWE GEWICHT IS GEREGISTREERD.</p><button onClick={() => { setShowSuccessSaved(false); setPagina('instellingen'); }} className="w-full bg-blue-600 text-white py-5 rounded-2xl font-black text-lg uppercase italic">PAS MIJN PLAN NU AAN</button></div></div>)}
        ...
        <nav className="absolute bottom-0 left-0 right-0 bg-white border-t-2 border-gray-100 flex justify-around p-2 pb-10 shadow-2xl z-50 rounded-t-3xl font-black italic">
            ...
            <button onClick={() => gaNaar('planner')} className={`flex flex-col items-center gap-1 group w-20 py-2 italic font-black ${pagina === 'planner' ? 'text-blue-700' : 'text-black opacity-100'}`}><div className={`p-2 rounded-xl ${pagina === 'planner' ? 'bg-blue-50' : 'bg-transparent'} transition-all font-black`}><Calendar size={28} strokeWidth={2.5} /></div><span className="text-[10px] uppercase font-black italic font-black font-black font-black">WEEKPLAN</span></button>
            <button onClick={() => gaNaar('logboek')} className={`flex flex-col items-center gap-1 group w-20 py-2 italic font-black ${pagina === 'logboek' ? 'text-blue-700' : 'text-black opacity-100'}`}><div className={`p-2 rounded-xl ${pagina === 'logboek' ? 'bg-blue-50' : 'bg-transparent'} transition-all font-black`}><Scale size={28} strokeWidth={2.5} /></div><span className="text-[10px] uppercase font-black italic font-black font-black">RESULTAAT</span></button>
